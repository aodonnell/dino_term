...
# Running the Demo
dino_term is built using make. It depends on the ncurses library for building. You can install the library in linux using one of the following commands for mac and linux
### Linux
``` console
